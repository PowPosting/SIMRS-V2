                    ...
                    <form action="<?= base_url('profile/update') ?>" method="post" id="profileForm">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                ...
                                <?php if (isset($user['spesialisasi']) && $user['role'] === 'dokter'): ?>
                                <div class="mb-3">
                                    <label for="spesialisasi" class="form-label">Spesialisasi</label>
                                    <input type="text" class="form-control form-control-sm" id="spesialisasi" 
                                           value="<?= $user['spesialisasi'] ?>" readonly>
                            ...
                            <div class="col-md-4">
                                <div class="mb-3">
                                    ...
                                    <textarea class="form-control form-control-sm" id="alamat" name="alamat" rows="4" placeholder="Alamat lengkap"><?= old('alamat', $user['alamat']) ?></textarea>
                                </div>
                                <!-- Submit Buttons -->
