...
<div class="row px-4 mb-4">
    <div class="col-12 mb-3">
        ...
        <p class="text-muted">Akses cepat ke fitur utama sistem</p>
    </div>
    
    <div class="col-lg-2 col-md-4 col-sm-6 mb-4">
        <div class="card quick-action-btn h-100 text-center border-0 shadow-sm">
            <div class="card-body py-4">
                <i class="fas fa-user-plus fa-2x text-primary mb-3"></i>
                <h6 class="card-title mb-2">Daftar Pasien</h6>
                <p class="card-text text-muted small">Registrasi pasien baru</p>
                <a href="<?= base_url('admisi/registrasi-pasien') ?>" class="btn btn-primary btn-sm">Akses</a>
            </div>
        </div>
    </div>
    ...
    <div class="col-lg-2 col-md-4 col-sm-6 mb-4">
        <div class="card quick-action-btn h-100 text-center border-0 shadow-sm">
            <div class="card-body py-4">
                ...
                <h6 class="card-title mb-2">Data Pasien</h6>
                <p class="card-text text-muted small">Lihat data pasien</p>
                <a href="<?= base_url('shared/datapasien') ?>" class="btn btn-success btn-sm">Akses</a>
            </div>
        </div>
    </div>
    ...
    <div class="col-lg-2 col-md-4 col-sm-6 mb-4">
        <div class="card quick-action-btn h-100 text-center border-0 shadow-sm">
            <div class="card-body py-4">
                ...
                <h6 class="card-title mb-2">Antrian</h6>
                <p class="card-text text-muted small">Kelola antrian</p>
                <a href="<?= base_url('perawat/antrian-pendaftaran') ?>" class="btn btn-info btn-sm">Akses</a>
            </div>
        </div>
    </div>
    ...
    <div class="col-lg-2 col-md-4 col-sm-6 mb-4">
        <div class="card quick-action-btn h-100 text-center border-0 shadow-sm">
            <div class="card-body py-4">
                <i class="fas fa-stethoscope fa-2x text-warning mb-3"></i>
                <h6 class="card-title mb-2">Pemeriksaan</h6>
                <p class="card-text text-muted small">Antrian dokter</p>
                <a href="<?= base_url('dokter/antrian-poli') ?>" class="btn btn-warning btn-sm">Akses</a>
            </div>
        </div>
    </div>
    ...
    <div class="col-lg-2 col-md-4 col-sm-6 mb-4">
        <div class="card quick-action-btn h-100 text-center border-0 shadow-sm">
            <div class="card-body py-4">
                ...
                <h6 class="card-title mb-2">Farmasi</h6>
                <p class="card-text text-muted small">Kelola obat</p>
                <a href="<?= base_url('farmasi/data-master-obat') ?>" class="btn btn-danger btn-sm">Akses</a>
            </div>
        </div>
    </div>
    ...
    <div class="col-lg-2 col-md-4 col-sm-6 mb-4">
        <div class="card quick-action-btn h-100 text-center border-0 shadow-sm">
            <div class="card-body py-4">
                ...
                <h6 class="card-title mb-2">Pengaturan</h6>
                <p class="card-text text-muted small">Kelola sistem</p>
                <a href="<?= base_url('admin') ?>" class="btn btn-secondary btn-sm">Akses</a>
            </div>
        </div>
    </div>
</div>
