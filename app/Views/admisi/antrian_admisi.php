...
<head>
    ...
    <title>Antrian Nurse Station - <?= $no_antrian ?? '-' ?></title>
    <style>
        * {
            margin: 0;
            padding: 0;
...
<body onload="window.print()">
    <div class="struk">
        ...
        log_message('info', '[View antrian_admisi] Data antrian: ' . json_encode($antrian));
        ?>
        <div class="info-row">
        ...
        <div class="info-row">
            ...
            <div class="info-value">: NURSE STATION</div>
        </div>
        <div class="info-row">
            <div class="info-label">Status</div>
            <div class="info-value">: Menunggu Pemeriksaan Awal</div>
        </div>

        <!-- Warning -->
        <div class="warning">
            <strong>PERHATIAN!</strong><br>
            Harap menunggu panggilan di area Nurse Station<br>
            untuk pemeriksaan vital sign (TD, Suhu, BB, TB)
        </div>
