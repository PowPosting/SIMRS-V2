                                ...
                                <div class="col-md-6 col-xl-4 mb-4">
                                    <div class="card h-100 border-0 shadow-sm hover-shadow">
                                        <div class="card-body position-relative">
                                            ...
                                            <button class="btn btn-success btn-block btn-mulai-pemeriksaan-dokter" data-id="<?= esc($antrian['id']) ?>">
        ...
        <div class="col-md-6 col-xl-4 mb-4">
            <div class="card h-100 border-0 shadow-sm hover-shadow">
                <div class="card-body position-relative">
                    ...
                    <button class="btn btn-success btn-block btn-mulai-pemeriksaan-dokter" data-id="{{id}}">
                        <i class="fas fa-user-md mr-2"></i>Mulai Pemeriksaan Dokter
                    </button>
                </div>
            </div>
